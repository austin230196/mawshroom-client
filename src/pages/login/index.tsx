        ...
        <Layout>
            <div className="flex-1 min-h-screen flex items-center justify-center">
                <div className="flex-1 flex flex-col items-center justify-center max-w-[600px] p-4 md:p-10 mx-auto">
                    <h3 className="lg:text-[40px] text-[30px] text-white font-bold" style={{ fontFamily: "'Rubik Bubbles', sans-serif" }}>Log In</h3>
                    <h4 className="text-[var(--tertiary-text-color)] lg:text-[16px] text-[14px] mb-6">Mine - Earn - Withdraw</h4>
                    ...
                    <Button className="w-full py-[16px] text-[var(--primary-text-color)] bg-[var(--primary-bg-color)] flex items-center justify-center gap-4">Log In</Button>
