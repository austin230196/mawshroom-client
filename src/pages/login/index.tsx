        ...
        <Layout>
            <div className="flex-1 min-h-screen flex items-center justify-center">
                <div className="flex-1 flex flex-col items-center justify-center max-w-[600px] p-6 md:p-10 mx-auto">
                    <h3 className="lg:text-[40px] text-[30px] text-white font-bold animate-fade-in-up" style={{ fontFamily: "'Rubik Bubbles', sans-serif" }}>Log In</h3>
                    <h4 className="text-[var(--tertiary-text-color)] lg:text-[16px] text-[14px] mb-6 stagger-1 animate-fade-in-up">Mine - Earn - Withdraw</h4>
                    ...
                    <Button className="w-full py-[16px] text-[var(--primary-text-color)] bg-[var(--primary-bg-color)] flex items-center justify-center gap-4 stagger-4 animate-scale-in transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">Log In</Button>

                    <div className="flex w-full items-center justify-between gap-4 my-8 stagger-4 animate-fade-in">
